...
export default function Footer() {
    return (
        <div className="container-fluid bg-danger text-white mt-5 py-5 px-sm-3 px-md-5">
            <div className="row pt-5">
                <div className="col-lg-3 col-md-6 mb-5">
                    <a href="/" className="navbar-brand font-weight-bold text-primary m-0 mb-4 p-0" style={{ fontSize: "40px", lineHeight: "40px" }}>
                        ...
                        <span className="text-white"> EduSync</span>
                    </a>
                    <p>Our Institute Management System simplifies the administration of educational institutions by managing classes, teachers, and student records. Designed for easy use, it enhances efficiency and fosters a better learning environment for all</p>
                ...
                <div className="col-lg-3 col-md-6 mb-5">
                    ...
                    <div className="d-flex">
                        <i className="fa fa-2x fa-envelope text-primary"></i>
                        <div className="pl-3">
                ...
                <div className="col-lg-3 col-md-6 mb-5">
                    ...
                    <div className="d-flex flex-column justify-content-start">
                        ...
                        <a className="text-white mb-2" href="/"><i className="fa fa-angle-right mr-2"></i>Our Classes</a>
            ...
            <div className="container-fluid pt-5" style={{ borderTop: "1px solid rgba(23, 162, 184, .2)" }}>
                <p className="m-0 text-center text-white">
                    &copy; <a className="text-primary font-weight-bold" href="/">Your Site Name</a>. All Rights Reserved.
